// Inheritence:-Inheritance is a mechanism in object-oriented programming where a new class (subclass or derived class) is based on an existing class (superclass or base class), inheriting its attributes and behaviors. This allows for code reuse, extensibility, and the creation of a hierarchical relationship between classes.
//ex- one coder and dancer
